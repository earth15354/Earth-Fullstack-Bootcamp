...
// const newPost = {name: "sparky", age: 10};
...
function start() {
    const client = new MongoClient("mongodb+srv:// EM15354:<catspear4>@cluster0.inqjw.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
    client.connect()
        .then(() => {
