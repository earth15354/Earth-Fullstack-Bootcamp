(function (global, factory) {
    ...
    (global = global || self, global.ImageSlider = factory(global.vueCompositionApi));
    ...
    var script = compositionApi.createComponent({
      ...
      setup: function setup(props) {
        var ResizeObserver = typeof window !== 'undefined' ? window.ResizeObserver || index : index;
        var slider = compositionApi.ref(null);
        var sliderWidth = compositionApi.ref(0);
        var isMobile = compositionApi.computed(function () {
          return sliderWidth.value < 768;
        });
        var visibleCount = compositionApi.computed(function () {
          return isMobile.value ? 2 : 4;
        });
        var groups = compositionApi.computed(function () {
        ...
        var groupStyles = compositionApi.computed(function () {
          var styles = [];
        ...
        var imgWrapperWidth = compositionApi.computed(function () {
          return sliderWidth.value / visibleCount.value + 'px';
        });
        var activeGroupIndex = compositionApi.ref(null);
        compositionApi.onBeforeUnmount(compositionApi.watch(groups, function (g) {
          return activeGroupIndex.value = 0;
        }));
        var ob = compositionApi.ref(null);
